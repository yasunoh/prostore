    ...
    <Tailwind>
      ...
      <Body className="font-sans bg-white">
        <Container className="max-w-xl">
          ...
          <Section className="border border-solid border-gray-500 rounded-md p-4 md:p-6 my-4">
              ...
              <Row key={item.productId} className="mt-8">
                <Column className="w-20">
                  <Img  
                    ...
                    alt={item.name}
                    className="rounded"
                    src={ item.image.startsWith('/') ? `${process.env.SERVER_URL}${item.image}` : item.image }
                  />
                </Column>
